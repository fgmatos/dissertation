...
\program{Mestrado em Ci\^encias da Computa\c{c}\~ao}

% Área de titulação
% e.g. \majorfield{Ciência da Computação}
\majorfield{Ci\^encia da Computação}
...
\author{Fabiano Matos}

% Orientador(a)
% Opção: [f] - para orientador do sexo feminino
% e.g. \adviser[f]{Profa. Dra. Maria Santos}
\adviser{Prof. Dr. Robson Nasciemento}
...
%  \end{epigraph}
\begin{epigraph}[Nota de teste]{Fabiano Matos}
